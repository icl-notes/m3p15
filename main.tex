...
\begin{theorem}[Units in $ \Z\sbr{i} $]
...
\begin{theorem}[Unique factorisation in $ \Z\sbr{i} $]
...
\begin{theorem}[Decomposition of primes in $ \Z\sbr{i} $]
\hfill
\begin{enumerate}
...
\begin{theorem}[Units in $ \Z\sbr{w} $]
...
\begin{theorem}[Unique factorisation in $ \Z\sbr{\omega} $]
...
\begin{theorem}[Decomposition of primes in $ \Z\sbr{\omega} $]
\hfill
\begin{enumerate}
\item $ 3 $ ramifies.
